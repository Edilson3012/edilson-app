...
<head>
    ...
    <!-- bootstrap core css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('css/template-one/bootstrap.css') }}" />
    <!-- font awesome style -->
    <link href="css/font-awesome.min.css" rel="stylesheet" />
    <!-- Custom styles for this template -->
    <link href="{{ asset('css/template-one/style.css') }}" rel="stylesheet" />
    <!-- responsive style -->
    <link href="css/responsive.css" rel="stylesheet" />
    <link href="{{ asset('css/template-one/responsive.css') }}" rel="stylesheet" />
</head>
...
<body>
    <div class="hero_area">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="true"> <span class="nav-label">Chapa <span
                                            class="caret"></span></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">Planejamento</a>
                            </li>
                            <li class="nav-item">
        ...
        <section class="slider_section ">
            <div class="slider_bg_box">
                <img src="{{ asset('images/template-one/slider-bg.jpg') }}" alt="">
            </div>
        ...
        <div class="container">
            <div class="box">
                <div class="arrival_bg_box">
                    <img src="{{ asset('images/template-one/arrival-bg.png') }}" alt="">
                </div>
                <div class="row">
    ...
    <section class="product_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    Candidatos <span>parceiros</span>
                </h2>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        <div class="img-box">
                            <img src="{{ asset('images/anonimo/anonimo-1.jpg') }}" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Candidato 01
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        <div class="img-box">
                            <img src="{{ asset('images/anonimo/anonimo-2.jpg') }}" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Candidato 01
                            ...
                            <div class="img_container">
                                <div class="img-box">
                                    <div class="img_box-inner">
                                        <img src="{{ asset('images/template-one/client.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="detail-box">
    ...
    <div class="cpy_">
        <p class="mx-auto"><a href="https://html.design/"></a><br>
            Desenvolvido por: <a href="#" target="_blank">Edilson Murbach LTDA</a>
        </p>
    </div>
    <!-- jQery -->
